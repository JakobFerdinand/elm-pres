-- this was copied from elm-lang.org homepage
    ...
    el attributes <|
        html <|
            Svg.svg [ HtmlAtt.width 323, HtmlAtt.height 323 ]
                [ Svg.path [ fill "#F0AD00", d "m162 153 70-70H92z" ] []
                , Svg.path [ fill "#7FD13B", d "m9 0 70 70h153L162 0zM247 85l77 76-77 77-76-77z" ] []
                , Svg.path [ fill "#60B5CC", d "M323 144V0H180z" ] []
                , Svg.path [ fill "#5A6378", d "M153 162 0 9v305z" ] []
                , Svg.path [ fill "#F0AD00", d "m256 247 67 67V179z" ] []
                , Svg.path [ fill "#60B5CC", d "M162 171 9 323h305z" ] []
                ]
